!(function (e, t) {
  ...
  function Ie(e, t, n) {
    he(e, n["show".concat(H(t), "Button")], "inline-block"),
  ...
  const De = [
      ...
      return e && t.icon === e.icon
        ...
        ? t.icon && -1 === Object.keys(o).indexOf(t.icon)
          ? (l(
            ...
            x(n))
          : (B(n), Je(n, t), _e(n, t), void k(n, t.showClass.icon))
        : x(n);
    },
    _e = (e, t) => {
    ...
    ut = (e) => {
      ...
      t &&
        (I(t, ["type", "label", "placeholder", "value"]),
  ...
  function Nt(e, t, n, o) {
    re() ? Wt(e, o) : (Ce(n).then(() => Wt(e, o)), Mt(T)),
      ...
      "function" == typeof n.willClose && n.willClose(t),
        s
          ? ((s = e),
            ...
            (i = n.returnFocus),
            (a = n.didClose),
            (T.swalCloseEventFinishedCallback = Nt.bind(null, s, t, i, a)),
  ...
  const Kt = (e) => {
      e.isAwaitingPromise()
        ? (Yt(L, e), L.awaitingPromise.set(e, !0))
        : (Yt(jt, e), Yt(L, e));
    },
    Yt = (e, t) => {
  ...
  const Zt = (e, t) => {
      ...
      if (n.inputValidator) {
        ...
        c.then((e) => {
          i.enableButtons(),
            i.enableInput(),
            e ? i.showValidationMessage(e) : ("deny" === r ? Jt : Qt)(i, a);
        });
      } else
  ...
  var pn = Object.freeze({
    ...
    argsToParams: (n) => {
      const o = {};
      return (
        "object" != typeof n[0] || rn(n[0])
          ? ["title", "html", "icon"].forEach((e, t) => {
              t = n[t];
              "string" == typeof t || rn(t)
                ? (o[e] = t)
                : void 0 !== t &&
                  l(
                    "Unexpected type of "
  ...
  class D {
    ...
    _main(e) {
      var t =
        ...
        e =
          (J(Object.assign({}, t, e)),
          T.currentInstance && (T.currentInstance._destroy(), ae() && it()),
  ...
  const hn = (l, u, d) =>
      new Promise((e, t) => {
        ...
        jt.swalPromiseResolve.set(l, e),
          ...
          (u.denyButton.onclick = () => {
            var e = l,
              t = L.innerParams.get(e);
            e.disableButtons(),
              t.returnInputValueOnDeny ? Zt(e, "deny") : Jt(e, !1);
          }),
              ...
              (M(g()), Et(a, t));
        {
          ...
          "function" == typeof r.willOpen && r.willOpen(c),
            ...
            ae() && (Pt(s, r.scrollbarPadding, e), ot()),
            re() ||
    ...
    gn = (e, t) => {
      var n = ((e) => {
        ...
        (e = e.content),
          pt(e),
          (e = Object.assign(rt(e), st(e), ct(e), lt(e), ut(e), dt(e, at)));
        return e;
      })(e);
